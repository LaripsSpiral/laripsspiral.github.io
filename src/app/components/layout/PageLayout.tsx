...
export function PageLayout({ children, transparentBackground = false }: PageLayoutProps) {
  ...
  const copyEmailToClipboard = async () => {
    try {
      await navigator.clipboard.writeText('sirasit.tumv@gmail.com');
      setEmailCopied(true);
          ...
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              ...
              <nav className="flex items-center gap-4">
                <a
                  href="https://github.com/laripsspiral"
                  target="_blank"
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">sirasit.tumv@gmail.com</span>
                  </button>
                  {emailCopied && (
