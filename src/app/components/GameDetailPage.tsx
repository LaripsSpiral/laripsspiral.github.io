                        ...
                        <div className="flex-1">
                          {awardCover ? (
                            <div className="space-y-2">
                              ...
                              <span className="text-gray-300 text-xs sm:text-sm md:text-base block">{awardTitle}</span>
                            </div>
                          ) : (
                            <span className="text-gray-300 text-xs sm:text-sm md:text-base">{awardTitle}</span>
                          )}
                        </div>
                      </div>
                    );
